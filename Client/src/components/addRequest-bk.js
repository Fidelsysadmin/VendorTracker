...
function AddRequest(){
    ...
    const {dor_time,request_from,co_ordinator,source_language,target_language,service_type,particulars,status,createdBy,date_of_closure,filename,mimetype,path,files} = requestData;
       ...
       const onSubmit = async e => {
        ...
        if(isValid == true)
        {
           ...
           // data.append('co_ordinator',requestData.co_ordinator);
            // if(requestData.files[0].length > 0)
            // {
                data.append('file', requestData.files[0]);
            ...
            data.append('eCode',requestData.eCode);
    ...
    const formValidation = (e) =>{
        ...
        if(isValidRequestDate == true && isValidRequestFrom == true && isValidCoordinator == true && isValidSource == true && isValidTarget == true && isValidServieType == true && isValidParticulars == true && isValidStatus == true && isValidRequestClosureDate == true && isValidFile ==true)
        {
            isValid = true;
        }else
        {
